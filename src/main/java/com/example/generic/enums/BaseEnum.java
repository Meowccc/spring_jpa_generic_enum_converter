...
public interface BaseEnum<T> {
     ...
     */
    static <E extends Enum<E> & BaseEnum<T>, T> E getEnumByValue(T value, Class<E> enumClass) {
     ...
     */
    static <E extends Enum<E> & BaseEnum<T>, T> E getEnumByName(String name, Class<E> enumClass) {
        return EnumSet.allOf(enumClass).stream()
     ...
     * get value by name
     */
    static <E extends Enum<E> & BaseEnum<T>, T> T getValueByName(String name, Class<E> enumClass) {
     ...
     */
    static <E extends Enum<E> & BaseEnum<T>, T> EnumSet<E> getEnums(Class<E> enumClass) {
